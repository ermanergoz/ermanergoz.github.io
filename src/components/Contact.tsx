...
const Contact = () => {
  return (
    <div className="contact">
      <h1>Contact</h1>
      <p>
        If you have a project in mind that you would like to discuss, lets get
      ...
      <div className="contact__card-container">
        ...
        {/*
        <Link
          destination="https://medium.com/@yusufermanergz"
          external={true}
          children={
            <UiButton
              theme="light"
              label="Medium"
              icon={<Image src={MediumLogo} alt="My MediumLogo profile" />}
            />
          }
        />
        */}
